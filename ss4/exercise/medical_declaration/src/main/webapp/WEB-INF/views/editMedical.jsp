...
<body>
<form:form action="/update?id=${MedicalDeclaration.id}" method="post" modelAttribute="MedicalDeclaration">
    <div>
        <div style="text-align: center">
            <h2>Sửa thông tin tờ khai y tế</h2>
            <h2>TỜ KHAI Y TẾ</h2>
        ...
        <div>
            <label>Thông tin đi lại <span>(*)</span></label>
                <%--            <input type="checkbox" value="Tàu bay">Tàu bay--%>
                <%--            <input type="checkbox" value="Tàu thuyền">Tàu thuyền--%>
                <%--            <input type="checkbox" value="Ô tô">Ô tô--%>
                <%--            <form:radiobuttons path="transport" items="${transport}"></form:checkboxes>--%>
